...
import { CheckCircle2, ChevronRight, FileUp, Loader2, Maximize, Building2, Landmark, Zap } from "lucide-react";
import Link from "next/link";

const steps = [
  { id: 1, name: "Business Details", icon: Building2 },
  { id: 2, name: "Financial Data", icon: Landmark },
  { id: 3, name: "Docs & OCR", icon: FileUp },
  { id: 4, name: "Smart Offer", icon: Zap }
];
  ...
  const handleNext = () => {
    if (currentStep < 4) {
      if (currentStep === 2 || currentStep === 3) {
        ...
        }, 2500); // Simulate API connection or OCR processing
      } else {
        setCurrentStep(prev => prev + 1);
      }
    }
        ...
        <AnimatePresence mode="wait">
           {isProcessing ? (
             ...
             >
               ...
               <h3 className="text-xl font-semibold">
                 {currentStep === 2 ? "Fetching GST & Banking Insights..." : "Running AI Document Extraction..."}
               </h3>
             ...
             >
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <div className="space-y-2 md:col-span-2">
                   <Label htmlFor="businessName">Registered Business Name (Auto-fetched from GSTIN)</Label>
                   <Input id="businessName" value="TechVision Solutions Limited" readOnly className="bg-muted/50" />
                 </div>
                 <div className="space-y-2">
           ...
           {currentStep === 3 && (
             ...
             >
               ...
               <div className="border-2 border-dashed border-border rounded-2xl p-12 hover:bg-accent/50 transition-colors cursor-pointer flex flex-col items-center justify-center gap-4">
           ...
           {currentStep === 4 && (
             ...
             >
               ...
               <div className="bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/20 rounded-2xl p-8 max-w-lg mx-auto mb-8 shadow-inner relative overflow-hidden">
                 ...
                 <div className="text-5xl font-extrabold text-foreground mb-6">₹12,50,000</div>
